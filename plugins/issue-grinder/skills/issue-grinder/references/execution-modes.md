...
## Запрошенное сравнение расхода подписки

Сравнивай оценочный `% недельного пула`, отдельно качество, время и токены.
Используй актуальный `codex-token-usage-report`, когда доступен: точное дерево
root/descendants и категории cached input / uncached input / output. Не
копируй его калибровку в mode и не переводи старую денежную сумму одним
коэффициентом. Укажи дату калибровки, аккаунт/план и ограничения по моделям;
это оценка, не серверный счётчик. Без счётчика/калибровки оставь проценты
неизвестными и покажи токены. Не добавляй такой отчёт к обычному delivery.
