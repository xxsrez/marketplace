...
Без явного выбора небольшой/средний объём → `Соло`, обоснованно крупный →
`Классический`, независимо от модели и числа карточек. Крупный объём требует
...
координации. При сомнении — `Соло`. `Баланс` и `Экономичный` только явно.
