...
Если обязательный comment не появился и не был перечитан, существенный status
transition не завершён. Конституция не предписывает, какой tool выбрать или как
устранять конкретный сбой; она требует фактический durable результат и запрещает
подменять его `description` либо ответом в Codex.
...
Объяснить, что нельзя установить и почему, что уже доказано, а
